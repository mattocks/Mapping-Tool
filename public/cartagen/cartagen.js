...
Tool.Point = {
	...
	mousedown: function() {
	}.bindAsEventListener(Tool.Point),
	mouseup: function() {
		$l('Landmark mouseup')
...
Tool.Rectangle = {
	...
	mouseup: function() {
		$l('Rectangle mouseup')
		if(Landmark.obj instanceof ControlPoint){
			if(Landmark.obj.parent_shape.finished){
			}
		}
		Landmark.temp_shape.active = true
		Landmark.obj = null
...
Tool.Textnote = {
	...
	mouseup: function() {
		...
		if(Landmark.obj instanceof ControlPoint){
			if(Landmark.obj.parent_shape.finished){
				Landmark.obj.parent_shape.pt = null
			}
		}
		Landmark.temp_shape.active = true
		Landmark.obj = null
